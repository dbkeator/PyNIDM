...
nidm_doc.addAttributesWithNamespaces([{"prefix":"nidm", "uri":nidm_doc.namespaces["nidm"], "term":"score", "value":int(15)}, \
...
nidm_doc.addAttributes({"nidm:test":int(15), "ncit:isTerminology":"15","ncit:joker":float(1)})
